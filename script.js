...
function v(){
  ...
  v1.style.transform = "rotateX(180deg)";
  v1.style.top = "3px";
}
...
function ok(){
  var interup = document.getElementById("interup");
  interup.style.visibility = "hidden";
  var latarInterup = document.getElementById("latarInterup");
  document.getElementById("latarInterup").style.visibility = "hidden";
}